    ...
    <div class="row">
      ...
      <div class="col-12 col-md-4">
        <div class="btn-group mr-md-3 circled w-100 wborder">
            <a href="/rent/houses" class="btn circled btn-inactive w-100" id="houses">Дома</a>
            <a href="/rent/townhouses" class="btn btn-inactive circled w-100" id="townhouses">Таунхаусы</a>
            <a href="javascript:void(0)" class="btn circled btn-active btn-c-primary w-100" id="areas">Участки</a>
        </div>
      </div>
      <div class="col-12 col-md-3 wborder">
        <div class="btn-group mr-3 circled w-100 wborder">
            <a href="/sale/areas" class="btn btn-inactive circled w-100">Продажа</a>
