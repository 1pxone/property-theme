...
<?php
  function max_meta_value(){
      global $wpdb;
      $query = "SELECT max(cast(meta_value as unsigned)) FROM wp_postmeta WHERE meta_key='price'";
      $the_max = $wpdb->get_var($query);
      return $the_max;
  }
  function min_meta_value(){
      global $wpdb;
      $query = "SELECT min(cast(meta_value as unsigned)) FROM wp_postmeta WHERE meta_key='price'";
      $the_max = $wpdb->get_var($query);
              ...
              <div class="row">
               ...
               <div class="col-12 col-lg-4 col-xl-4">
                  <div class="row mb-3">
                    ...
                    <div class="col-12 col-sm-6">
                        <input type="number" name="area_min" placeholder="от" class="form-control" aria-label="Text input with checkbox">
                    </div>
                    <div class="col-12 col-sm-6">
                        <input type="number" name="area_max" placeholder="до" class="form-control" aria-label="Text input with radio button">
                    </div>
                  </div>
                </div>
                <div class="col-12 col-lg-4 col-xl-4">
